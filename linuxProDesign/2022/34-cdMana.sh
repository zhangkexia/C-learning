...
# This program is distributed in the hopes that it will be usefull, but
# WITHOUT ANY WARRANTY; without event the implied warranty of
# MERCHANTABILITY or FINTNESS FOR A PARTICULAR PURPOSE. See the GNU General
...
set_menu_choice() {
    ...
    if [ "$cdcatnum" != "" ];then
        ...
        echo "    u) Update trace informantion for $cdtitle"
    fi
    echo "    q) Quit"
    echo
